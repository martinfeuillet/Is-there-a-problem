...
class ItapPageArchive
{
     ...
     */
    function itap_partial_archive() : void {
    ...
    /**
     * @param $error array that contain the error
     */
    function itap_archive_display_tab( array $error ) : string {
        $allowed_html = array(
            'div'  => array(
                'class' => array()
            ) ,
     ...
     */
    function itap_get_archive_from_database() : array {
        global $wpdb;
