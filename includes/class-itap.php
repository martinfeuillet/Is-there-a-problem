...
class Itap {
	 ...
	 *  
	 * @access   protected
	 * @var      Itap_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-itap-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-itap-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-itap-admin.php';

		$this->loader = new Itap_Loader();
	}
	 ...
	 *
	 *  
	 * @return    Itap_Loader    Orchestrates the hooks of the plugin.
	 */
